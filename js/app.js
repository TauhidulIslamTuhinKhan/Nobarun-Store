...
//   const url = `https://raw.githubusercontent.com/biswajitdasme/fakestore/main/db.json?fbclid=IwAR2PdRUyZsR-Crr1RgiFgyPYJ_HJg6hJgs0PrzkH74-ntss0XoaWJT7nldU`;
//   fetch(url)
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <button id="details-btn" class="btn btn-info">Details</button> <br>      
      <span>Total Rating : ${product.rating.count}</span> <br>  <span>Avarage Rating : ${product.rating.rate}</span>
      </div>
      `;
